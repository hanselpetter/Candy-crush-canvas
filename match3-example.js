...
window.onload = function() {
    ...
    // All of the different tile colors in RGB
    var tileimages = ["./assets/sandy0.png",
                    "./assets/sandy1.png",  
                    "./assets/sandy2.png",  
                    "./assets/sandy3.png",  
                    "./assets/sandy4.png",  
    ...
    // Gui buttons
    var buttons = [ { x: 30, y: 100, width: 80, height: 30, text: "New Game"},
                    { x: 120, y: 100, width: 80, height: 30, text: "Show Moves"},
                    { x: 210, y: 100, width: 80, height: 30, text: "Enable AI Bot"}];
    ...
    function render() {
        ...
        drawCenterText("Score:", 320, 95, 10);
        drawCenterText(score, 320, 125, 10);
    ...
    function drawFrame() {
        ...
        context.fillStyle = "#ffffff";
        context.font = "24px Verdana";
        context.fillText("Candy Crush", 10, 30);
    ...
    function drawButtons() {
        for (var i=0; i<buttons.length; i++) {
            ...
            context.fillText(buttons[i].text, buttons[i].x + (buttons[i].width-textdim.width)/2, buttons[i].y+16);
        }
    }
    ...
    function removeClusters() {
        ...
        loopClusters(function(index, column, row, cluster) { 
            ...
            if (cluster.length == 4)
                level.tiles[currentmove.column1][currentmove.row1].type = 7;
            else if (cluster.length == 5)
                level.tiles[currentmove.column1][currentmove.row1].type = 8;
        });
